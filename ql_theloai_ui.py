# Form implementation generated from reading ui file 'ui files\ql_theloai.ui'
#
...
class Ui_ql_theloaiWindow(object):
    def setupUi(self, ql_theloaiWindow):
        ...
        ql_theloaiWindow.resize(770, 498)
        icon = QtGui.QIcon()
    ...
    def retranslateUi(self, ql_theloaiWindow):
        ...
        self.maRow.setPlaceholderText(_translate("ql_theloaiWindow", "Mã: #00"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ql_theloaiWindow = QtWidgets.QMainWindow()
    ui = Ui_ql_theloaiWindow()
    ui.setupUi(ql_theloaiWindow)
    ql_theloaiWindow.show()
    sys.exit(app.exec())
